...
User Function AplicaDesc(nValTotal)
  ...
  oGetDesconto := TGet():New( 8,28,{|u| If( PCount() == 0, cPor, cPor:=u )},oDlgAplicaDesc,92,13,"@E 99,99",,0,,,.F.,,.T.,,.F.,,.F.,.F.,{||  CalcDesc(val(cPor),nValTotal)},.F.,.F.,,cPor,,,,)
